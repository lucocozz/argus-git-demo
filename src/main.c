...
ARGUS_OPTIONS(
    ...
    HELP_OPTION(),
    VERSION_OPTION(),
    OPTION_FLAG('v', "verbose", HELP("Be more verbose"), ENV_VAR("GIT_VERBOSE")),
    OPTION_FLAG('q', "quiet", HELP("Be more quiet"), ENV_VAR("GIT_QUIET"), CONFLICT("verbose")),
    OPTION_STRING('C', NULL, 
        HELP("Run as if git was started in <path> instead of the current "
             "working directory"), ENV_VAR("GIT_DIR"), HINT("path")),
    OPTION_MAP_STRING('c', NULL, 
    ...
    SUBCOMMAND("add", add_options, 
        ...
        ACTION(add_handler)),
    SUBCOMMAND("commit", commit_options, 
        HELP("Record changes to the repository"), 
        ACTION(commit_handler)),
    SUBCOMMAND("status", status_options, 
        HELP("Show the working tree status"), 
        ACTION(status_handler)),
    SUBCOMMAND("log", log_options, 
    ...
    SUBCOMMAND("stash", stash_options, 
