...
ARGUS_OPTIONS(
    ...
    OPTION_STRING('\0', "pretty",
        ...
        DEFAULT("medium"),
        HINT("format")),
    OPTION_STRING('\0', "format", HELP("Specify which information is shown")),
    OPTION_STRING('\0', "decorate-refs", HELP("Only decorate refs that match <pattern>")),
    OPTION_STRING('\0', "decorate-refs-exclude", HELP("Do not decorate refs that match <pattern>")),
    OPTION_STRING('\0', "decorate",
        ...
        DEFAULT("short"),
        FLAGS(FLAG_OPTIONAL)),
    OPTION_STRING('L', NULL,
        HELP("Trace the evolution of line range <start>,<end> or function :<funcname> in <file>"),
        HINT("range:file")),
    
    POSITIONAL_MANY_STRING("revision", HELP("Show commits reachable from given commits"), FLAGS(FLAG_OPTIONAL)),
)
