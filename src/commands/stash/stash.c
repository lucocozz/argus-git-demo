...
ARGUS_OPTIONS(
    ...
    OPTION_STRING(
        'm', "message",
        HELP("Use the given <msg> as the stash message"),
        HINT("msg")),
    OPTION_FLAG(
        'u', "include-untracked",
...
int stash_handler(argus_t *argus, void *data)
{
    ...
    // Default action is "push" for backward compatibility
