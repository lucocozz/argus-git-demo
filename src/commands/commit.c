...
ARGUS_OPTIONS(
    ...
    POSITIONAL_MANY_STRING(
        "pathspec",
        HELP("When pathspec is given on the command line, commit the contents of the files that match the pathspec without recording the changes already added to the index"),
        FLAGS(FLAG_OPTIONAL)
    ),
)
